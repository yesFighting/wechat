    ...
    <div>
        <div id="bac">
            <div class="">
                 <ul class="itme-1">
                    <li @click="onCancel(true)">
                        <a>
                            ...
                            <div>
                                <span>
                                  <van-icon color="#04c18d" name="location-o" />
                                </span>
                                <span class="bule">
                                    &nbsp;&nbsp;{{confirmPositions}}
                                </span>
                ...
                <div class="many-itme" >
                   <button ref="but" v-for="(item,index) in many" :class="{active:colSelected==index}" :key="index" @click="bacColor(index)" >{{item}}</button>
                </div>
...
export default {
    data(){
        return{
            ...
            many:[1000,1500,2000,2500,3000,5000],
            colSelected:null,
            inpMany:null,
            positions:'',
            confirmPositions:''
